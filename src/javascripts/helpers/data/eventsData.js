...
const editEventOnDatabase = (newEventObj, eventId) => axios.put(`${firebaseUrl}/event/${eventId}.json`, newEventObj);

export default {
  addEventToDatabase,
  retrieveEventsByUserId,
  removeEventFromDatabaseByEventId,
  editEventOnDatabase,
};
